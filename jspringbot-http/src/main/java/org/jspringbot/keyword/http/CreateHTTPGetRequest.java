...
@Component
@KeywordInfo(name = "Create HTTP Get Request", description = "Creates an HTTP Get Request.", parameters = {"url"})
public class CreateHTTPGetRequest extends AbstractHTTPKeyword {
