...
@Component
@KeywordInfo(
        name = "Screenshot List Collected",
        description = "classpath:desc/ScreenshotListCollected.txt"
)
public class ScreenshotListCollected implements Keyword {
