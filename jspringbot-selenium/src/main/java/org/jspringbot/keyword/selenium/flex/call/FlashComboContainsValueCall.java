...
public class FlashComboContainsValueCall implements FlashCall {

    private String objectId;
    private FlexSelenium flashApp;
    private String expectedValue;

    public FlashComboContainsValueCall(FlexSelenium flashApp, String objectId, String expectedValue) {
        super();
    ...
    public String getErrorMessage() {
        return "The selected item for " + objectId + " was not the value '" + expectedValue + "'" ;
    }
