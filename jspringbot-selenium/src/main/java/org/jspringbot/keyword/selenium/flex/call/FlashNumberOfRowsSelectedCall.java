...
public class FlashNumberOfRowsSelectedCall implements FlashCall {
    ...
    public FlashNumberOfRowsSelectedCall(FlexSelenium flashApp, String listId, int expectedRowCount) {
        super();
    ...
    public boolean attemptCall() {
        return flashApp.getNumSelectedItems(listId) == expectedRowCount;
    }

    @Override
    public String getErrorMessage() {
        return String.format("%s does not have %d selected rows", listId, expectedRowCount);
    }
}
